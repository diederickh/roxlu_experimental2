...
#include <glr/Mesh.h>
// #include <glr/Font.h> // conflicts with OF
...
namespace gl {
  ...
  void Drawer::createOrthographicMatrix() {
    ...
    ortho_matrix.orthoBottomLeft(window_w, window_h, 0.0f, 100.0f);
  }
  ...
  void glr_init() {
    ...
    // glr_font.init(); // conflicts with OF when compiling with cmake
  }
