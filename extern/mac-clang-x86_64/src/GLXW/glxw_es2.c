...
ctx->_glFramebufferTexture3DOES = (PFNGLFRAMEBUFFERTEXTURE3DOES)get_proc(libgl, "glFramebufferTexture3DOES");
...
ctx->_glDrawArraysInstancedNV = (PFNDRAWARRAYSINSTANCEDNVPROC)get_proc(libgl, "glDrawArraysInstancedNV");
ctx->_glDrawElementsInstancedNV = (PFNDRAWELEMENTSINSTANCEDNVPROC)get_proc(libgl, "glDrawElementsInstancedNV");
...
ctx->_glBlitFramebufferNV = (PFNBLITFRAMEBUFFERNVPROC)get_proc(libgl, "glBlitFramebufferNV");
ctx->_glRenderbufferStorageMultisampleNV = (PFNRENDERBUFFERSTORAGEMULTISAMPLENVPROC)get_proc(libgl, "glRenderbufferStorageMultisampleNV");
ctx->_glVertexAttribDivisorNV = (PFNVERTEXATTRIBDIVISORNVPROC)get_proc(libgl, "glVertexAttribDivisorNV");
